...
export async function GET(_req: NextRequest) {
  try {
    ...
    logger.debug("[API] /api/earnings-tomorrow date:", tomorrowStr);
    ...
    logger.debug(`[API] Found ${sortedResult.length} earnings records for tomorrow`);
    ...
    logger.error("[API] Error fetching tomorrow's earnings:", error);
    return NextResponse.json(
